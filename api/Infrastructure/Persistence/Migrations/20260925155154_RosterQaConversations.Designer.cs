...
namespace ExpertToJob.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925155154_RosterQaConversations")]
    partial class RosterQaConversations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpertToJob.Domain.Entities.RosterQaConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RosterQaConversations");
                });

            modelBuilder.Entity("ExpertToJob.Domain.Entities.RosterQaTurn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RosterQaTurns");
                });

            modelBuilder.Entity("ExpertToJob.Domain.Entities.RosterQaTurnExpert", b =>
                {
                    ...
                    b.HasKey("TurnId", "ExpertId");

                    b.HasIndex("ExpertId");

                    b.ToTable("RosterQaTurnExperts");
                });
            ...
            modelBuilder.Entity("ExpertToJob.Domain.Entities.ScoringJobCandidate", b =>
                {
                    ...
                    b.Property<string>("ContestOutcome")
                        .HasColumnType("text");

                    b.Property<string>("ContestResponse")
                        .HasColumnType("text");

                    b.Property<DateTimeOffset?>("ContestReviewedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("ContestReviewedByUserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ExpertToJob.Domain.Entities.RosterQaTurn", b =>
                {
                    b.HasOne("ExpertToJob.Domain.Entities.RosterQaConversation", null)
                        .WithMany("Turns")
            ...
            modelBuilder.Entity("ExpertToJob.Domain.Entities.RosterQaTurnExpert", b =>
                {
                    b.HasOne("ExpertToJob.Domain.Entities.RosterQaTurn", null)
                        .WithMany("TouchedExperts")
