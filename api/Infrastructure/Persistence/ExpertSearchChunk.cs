...
/// expert's free-text career narrative — a single work Experience, the expert's professional
...
/// </summary>
public class ExpertSearchChunk
{
    public Guid Id { get; set; }

    /// <summary>Owning expert; chunks cascade-delete with the expert.</summary>
    ...
    /// <summary>
    /// Id of the source row: the Experience id, the Achievement id, or the Expert id for a
